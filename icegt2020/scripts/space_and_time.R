...
# plotting Figure 9
jpeg(filename = "icegt2020/figures/fig_space_and_time.jpeg",
  width = 300, height = 140, units = "mm", res = 600)
layout(matrix(c(1, 2), nrow = 1, ncol = 2), widths = c(10, 2))
par(mar = c(3, 4.25, 0.25, 0.25), mgp = c(0.1, 0.1, 0),
...
par(las = 0)
mtext("Depth [mm]", side = 2, line = 3.25)
mtext("Time [DD-MM-2019]", side = 1, line = 1.5)
